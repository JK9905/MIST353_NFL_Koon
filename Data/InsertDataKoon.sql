...
--trigger tp track score updates by NFLAdmin to the Game table
--1. trigger events: after update on Game 
--2. Action: insert a record into AdminChangesTracker with NFLAdminID, ChangeType (score update)

--trigger trgTrackChangesOnEnteringScores
--ON Game
--after update
--as
